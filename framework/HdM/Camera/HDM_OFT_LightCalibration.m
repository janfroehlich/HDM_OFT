...
[RMax,RMaxInd]=max(OFT_SpectrumImage(OFT_SpectrumImageHeight/2,:,1));
[GMax,GMaxInd]=max(OFT_SpectrumImage(OFT_SpectrumImageHeight/2,:,2));

%if required rotate so that blue is always left

OFT_VCenterPos=0;
OFT_ValidCnt=0;
OFT_GlobalMax=max(OFT_SpectrumImage(:));
for R=10:OFT_SpectrumImageHeight-10 
    [GMax,GMaxInd]=max(OFT_SpectrumImage(R,:,2));
...
OFT_SpectrumROI_Top=OFT_SpectrumROI_Top+uint32(0.75*(OFT_Center-OFT_SpectrumROI_Top));
OFT_SpectrumROI_Bottom=OFT_SpectrumROI_Bottom-uint32(0.75*(OFT_SpectrumROI_Bottom-OFT_Center));
...
OFT_start=find(OFT_In_Pixel2WavelengthLookUp>=300);
OFT_end=find(OFT_In_Pixel2WavelengthLookUp>=900);
...
OFT_Spectrum_MeanOfRowsRed_nmSamples=...
    ...
    min(OFT_IntenityAgainstWavelength(1,:)):OFT_IntenityAgainstWavelength(1,2)-OFT_IntenityAgainstWavelength(1,1):max(OFT_IntenityAgainstWavelength(1,:)),...
    'linear');
...
OFT_NormalizedLight=OFT_IntenityAgainstWavelength(2,:)/max(OFT_IntenityAgainstWavelength(2,:))
...
plot...
    (OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsBlue_nmSamples,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsGreen_nmSamples,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsRed_nmSamples,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsBlue_nmSamplesCam,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsGreen_nmSamplesCam,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsRed_nmSamplesCam,...
    OFT_IntenityAgainstWavelength(1,:),OFT_NormalizedLight(1,:),...
    OFT_IntenityAgainstWavelength(1,:),OFT_NormalizedLightCorrection(1,:));
% hold on
% plot...
...
nmBase=380:10:730;
OFT_GridTransmissionNormIntensity=interp1(OFT_GridTransmission(1,:), OFT_GridTransmission(2,:),380:10:730,'pchip',0);
...
plot...
    ...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsGreen_nmSamples,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsRed_nmSamples,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsBlue_nmSamplesLight,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsGreen_nmSamplesLight,...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsRed_nmSamplesLight,...
    OFT_IntenityAgainstWavelength(1,:),OFT_GridTransmission_Correction)
% hold on
% plot...
%     (OFT_In_Pixel2WavelengthLookUp,OFT_Spectrum_MeanOfRows(1,:,3)/max(OFT_Spectrum_MeanOfRows(1,:,2)),'--',...
%     OFT_In_Pixel2WavelengthLookUp,OFT_Spectrum_MeanOfRows(1,:,2)/max(OFT_Spectrum_MeanOfRows(1,:,2)),'--',...
...
OFT_Out_SpectralResponse=[OFT_IntenityAgainstWavelength(1,:);...
...
plot...
    (OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsBlue_nmSamples/max(OFT_Spectrum_MeanOfRowsGreen_nmSamples),...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsGreen_nmSamples/max(OFT_Spectrum_MeanOfRowsGreen_nmSamples),...
    OFT_IntenityAgainstWavelength(1,:),OFT_Spectrum_MeanOfRowsRed_nmSamples/max(OFT_Spectrum_MeanOfRowsGreen_nmSamples))
% hold on
% plot...
%     (OFT_In_Pixel2WavelengthLookUp,OFT_Spectrum_MeanOfRows(1,:,3)/max(OFT_Spectrum_MeanOfRows(1,:,2)),'--',...
%     OFT_In_Pixel2WavelengthLookUp,OFT_Spectrum_MeanOfRows(1,:,2)/max(OFT_Spectrum_MeanOfRows(1,:,2)),'--',...
